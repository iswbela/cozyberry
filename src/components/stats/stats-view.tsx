  ...
  if (!stats) {
    return (
      <div className="text-center py-20 text-[var(--muted-foreground)]">
        No data available yet. Start journaling!
      </div>
    );
  }
          ...
          <CardContent className="pt-5 pb-4 text-center">
            {mostCommonMoodData ? (
              <>
                ...
                <p className="text-xs text-[var(--muted-foreground)]">Top Mood</p>
              </>
            ) : (
              <>
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={stats.monthly} margin={{ top: 0, right: 0, left: -20, bottom: 0 }}>
                ...
                />
                <Bar dataKey="count" fill="var(--primary)" radius={[6, 6, 0, 0]} name="Entries" />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
